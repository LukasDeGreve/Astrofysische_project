...
#Loading in data
p, x, y, z = np.genfromtxt("/home/wout/Documents/Astro_sim/Project/N_body_3D_versions/Positions100.txt", unpack = True)
...
def animate(i):
    ...
    ax.text2D(0.5,0.85,'100 particles',fontsize=14,horizontalalignment='center',verticalalignment='center',transform=ax.transAxes)
...
anim.save('N_body_3D_100_rigid_mass.mp4', fps=30, extra_args=['-vcodec', 'libx264'])
